...
def get_fm_tabel(fm_l,fm_u,mask_l,mask_u,table_size):
    ...
    if mask_l is not None:
        #print(mask_l.nonzero().squeeze(1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--range', default='0')
    ...
    txt_file = {'train': './MSTAR_128/' + datasetnum + '/mstar_train_' + range_ratio + '.txt',
                ...
                'un': './MSTAR_128/' + datasetnum + '/mstar_val_' + range_ratio + '.txt'}
    ...
    batch_size = {'labeled': 100,
                  ...
                  'un':50}
    cate_num = 10
    save_model_path = './MSTAR_128/' + datasetnum +'/' + range_ratio +'/model_mmd/slc_joint_deeper_img_' + str(datasetnum) + '_FR_'
    ...
    f_acc = open(result_dir+'/ssl_mmd_accuracy.txt','w')
    u_acc = open(result_dir + '/u_mmd_accuracy.txt', 'w')
    ...
    for epoch in range(epoch_num):
        ...
        for (data_labeled, data_unlabeled) in train_loader:
            ...
            total_loss= unsup_loss + sup_loss #+ 500*mmd_loss#
